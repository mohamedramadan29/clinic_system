    ...
    <div class="card">
        <div class="card-header">
            <button type="button" class="btn btn-primary waves-effect" data-toggle="modal" data-target="#add-Modal"> Add Option <i class="ti-plus"></i> </button>
        </div>
        <?php
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="main.php?dir=menus&page=delete&option_id=<?php echo $option['id']; ?>" class="confirm btn btn-danger btn-sm"> Delete </a>
                                </td>
                            </tr>
                                        ...
                                        <form action="main.php?dir=menus&page=edit" method="post" enctype="multipart/form-data">
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select required name="menu_num" class="form-control select" id="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select required name="meal_type" class="form-control select" id="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select required name="day" class="form-control select" id="day">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select required name="option_type" class="form-control select" id="option_type">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select required name="cat" class="form-control select" id="cat">
