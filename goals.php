            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-logo">
                        ...
                        <a href="index.php">
                            <img class="img-fluid" src="files\assets\images\lodgo.png" alt="Theme-Logo" width="75%" </a>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#!"> Goals  </a>
                                                        </li>
                                                        <li class="breadcrumb-item"><a href="#!"> All Goals  </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="card-block">
                                                        <section class="task-panel tasks-widget">
                                                            <div class="panel-body">
                                                                ...
                                                                <div>
                                                                    <a class="btn btn-primary btn-add-task waves-effect waves-light m-t-10" href="#" data-toggle="modal" data-target="#flipFlop"><i class="icofont icofont-plus"></i> Add New Goal</a>
                                                                </div>
                                                            </div>
                                                        </section>
                                                    </div>
                ...
                <div class="modal-body">
                    <div class="row"> 
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="text" class="form-control save_task_todo" placeholder="Date">
                        </div>
                    </div>
                </div>
