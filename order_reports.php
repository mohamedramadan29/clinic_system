                                                    ...
                                                    <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td> 12 / 2 / 2023 </td>
                                                                <td>
                                                                    <label for="" class="label label-md label-success"> تم بنجاح </label>
                                                                </td>
                                                                <td> 12 / 2 / 2023 </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td> 12 / 2 / 2023 </td>
                                                                <td>
                                                                    <label for="" class="label label-md label-warning"> تحت التنفيذ </label>
                                                                </td>
                                                                <td> 12 / 2 / 2023 </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td> 12 / 2 / 2023 </td>
                                                                <td>
                                                                    <label for="" class="label label-md label-danger"> تم الالغاء </label>
                                                                </td>
                                                                <td> 12 / 2 / 2023 </td>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" multiple="multiple">
                                                                <option value="AL">Menu 1 </option>
                                                                <option value="WY">Menu 2</option>
                                                                <option value="WY">Menu 3</option>
                                                                <option value="WY">Menu 4</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="Company-2" class="block"> Number </label>
                                                            <input id="Company-2" name="Company:" type="text" class="form-control required">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="Company-2" class="block"> date </label>
                                                            <input id="Company-2" name="Company:" type="date" class="form-control required">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="Company-2" class="block">Notes</label>
