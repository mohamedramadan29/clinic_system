            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-logo">
                        ...
                        <a href="index.php">
                            <img class="img-fluid" src="files\assets\images\logdo.png" alt="Theme-Logo" width="75%" </a>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label for="Company-2" class="block">Name</label>
                                                            <input id="Company-2" name="Company:" type="text" class="form-control required" value="Category 1">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="Company-2" class="block">Description</label>
                                                            <textarea name="" id="" class="form-control"> this is category one </textarea>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-default waves-effect " data-dismiss="modal">Close</button>
