            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-logo">
                        ...
                        <a href="index.php">
                            <img class="img-fluid" src="files\assets\images\lsgo.png" alt="Theme-Logo" width="75%" </a>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#!"> All Client </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <button type="button" class="btn btn-primary waves-effect" data-toggle="modal" data-target="#add-Modal"> Add Client <i class="ti-plus"></i> </button>
                                            </div>
                                                    ...
                                                    <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="progress ">
                                                                        <div class="progress-bar progress-bar-striped progress-bar-primary" role="progressbar" style="width: 60%" aria-valuenow="12" aria-valuemin="0" aria-valuemax="100"></div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="progress ">
                                                                        <div class="progress-bar progress-bar-striped progress-bar-primary" role="progressbar" style="width: 90%" aria-valuenow="12" aria-valuemin="0" aria-valuemax="100"></div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <button type="button" class="btn btn-success btn-sm waves-effect" data-toggle="modal" data-target="#edit-Modal"> <i class="ti-pencil"></i> </button>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="progress ">
                                                                        <div class="progress-bar progress-bar-striped progress-bar-primary" role="progressbar" style="width: 20%" aria-valuenow="12" aria-valuemin="0" aria-valuemax="100"></div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <button type="button" class="btn btn-success btn-sm waves-effect" data-toggle="modal" data-target="#edit-Modal"> <i class="ti-pencil"></i> </button>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="Company-2" class="block"> Plane </label>
                                                            <textarea name="" id="" class="form-control"></textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="Company-2" class="block"> Condtions </label>
                                                            <textarea name="" id="" class="form-control"></textarea>
                                                        </div>
                                                    </div>
